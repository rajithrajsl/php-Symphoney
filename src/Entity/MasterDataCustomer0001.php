...
/**
 * MasterDataCustomer0001
 *
 * @ORM\Table(name="master_data_customer_0001")
 * @ORM\Entity
 */
class MasterDataCustomer0001
{
    /**
     * @var int
     *
     ...
     * @var string|null
     *
     * @ORM\Column(name="konzs", type="string", length=40, nullable=true)
     */
    private $konzs;
     ...
     * @var int|null
     *
     * @ORM\Column(name="kunnr_rg", type="integer", nullable=true)
     */
    private $kunnrRg;
     ...
     * @var string|null
     *
     * @ORM\Column(name="waers", type="string", length=3, nullable=true)
     */
    private $waers;
    ...
    public function getKonzs(): ?string
    {
        return $this->konzs;
    }

    public function setKonzs(?string $konzs): self
    {
        $this->konzs = $konzs;
    ...
    public function getKunnrRg(): ?int
    {
        return $this->kunnrRg;
    }

    public function setKunnrRg(?int $kunnrRg): self
    {
        $this->kunnrRg = $kunnrRg;
    ...
    public function getWaers(): ?string
    {
        return $this->waers;
    }

    public function setWaers(?string $waers): self
    {
        $this->waers = $waers;
