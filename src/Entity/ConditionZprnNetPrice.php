...
/**
 * ConditionZprnNetPrice
 *
 * @ORM\Table(name="condition_zprn_net_price")
 * @ORM\Entity
 */
class ConditionZprnNetPrice
{
    /**
     * @var int
     *
     ...
     * @var int|null
     *
     * @ORM\Column(name="konda", type="integer", nullable=true)
     */
    private $konda;
     ...
     * @var string|null
     *
     * @ORM\Column(name="supkbetr_zraz", type="decimal", precision=8, scale=3, nullable=true, options={"default"="0.000"})
     */
    private $supkbetrZraz = '0.000';

    /**
     * @var string|null
     *
     * @ORM\Column(name="supkonwa_zraz", type="string", length=30, nullable=true)
     */
    private $supkonwaZraz;

    /**
     * @var int|null
     *
     * @ORM\Column(name="supkpein_zraz", type="integer", nullable=true)
     */
    private $supkpeinZraz = '0';

    /**
     * @var int|null
     *
     * @ORM\Column(name="supkmein_zraz", type="integer", nullable=true)
     */
    private $supkmeinZraz;
    ...
    public function getKonda(): ?int
    {
        return $this->konda;
    }

    public function setKonda(?int $konda): self
    {
        $this->konda = $konda;
    ...
    public function getSupkbetrZraz(): ?string
    {
        return $this->supkbetrZraz;
    }

    public function setSupkbetrZraz(?string $supkbetrZraz): self
    {
        $this->supkbetrZraz = $supkbetrZraz;

        return $this;
    }

    public function getSupkonwaZraz(): ?string
    {
        return $this->supkonwaZraz;
    }

    public function setSupkonwaZraz(?string $supkonwaZraz): self
    {
        $this->supkonwaZraz = $supkonwaZraz;

        return $this;
    }

    public function getSupkpeinZraz(): ?int
    {
        return $this->supkpeinZraz;
    }

    public function setSupkpeinZraz(?int $supkpeinZraz): self
    {
        $this->supkpeinZraz = $supkpeinZraz;

        return $this;
    }

    public function getSupkmeinZraz(): ?int
    {
        return $this->supkmeinZraz;
    }

    public function setSupkmeinZraz(?int $supkmeinZraz): self
    {
        $this->supkmeinZraz = $supkmeinZraz;
